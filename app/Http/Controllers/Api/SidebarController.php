...
class SidebarController extends Controller
{
    ...
    // public function BibleSearchResults(Request $request)
    // {
    //     try {
    ...
    // public function GQSearchResults(Request $request)
    // {
    //     try {
    ...
    //         $total_results = $color_qg_results->count();
            
    //         return $this->outputer->code(200)->metadata($total_results)
    //                                 ->success($color_qg_results)->json();
