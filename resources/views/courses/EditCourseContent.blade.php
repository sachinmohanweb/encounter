                                    ...
                                    <div class="add-link video-link-box pb-1">
                                       ...
                                       <div class="row align-items-center">
                                          ...
                                          <div class="col-lg-3 col-md-3 col-12 mb-2">
                                             ...
                                             {{-- Existing thumbnail preview will be shown here if available --}}
                                             @if(isset($link) && $link->thumbnail)
                                                <small class="text-muted">Current: {{ basename($link->thumbnail) }}</small>
                                                <img src="{{ asset($link->thumbnail) }}" alt="Current Thumbnail" class="video-thumbnail-preview">
                                             @endif
                                          </div>
                                    ...
                                    @foreach($content->CourseContentVideoLink as $key => $link)
                                       <div class="add-link video-link-box pb-1">
                                          ...
                                          <div class="row align-items-center">
                                             ...
                                             <div class="col-lg-3 col-md-3 col-12 mb-2">
                                                <input type="file" class="form-control" name="video_thumbnail[]" accept="image/*" placeholder="Thumbnail">
                                                <input type="hidden" name="existing_video_thumbnail[]" value="{{ $link->thumbnail ?? '' }}">
                                                @if($link->thumbnail)
                                                   <small class="text-muted">Current: {{ basename($link->thumbnail) }}</small>
                                                   <img src="{{ asset($link->thumbnail) }}" alt="Current Thumbnail" class="video-thumbnail-preview">
                                                @endif
